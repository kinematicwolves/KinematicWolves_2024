...
public class Lighting extends SubsystemBase {
  ...
  public void setTeleOpLightShow() {
    ...
    //animation = new ColorFlowAnimation(0, 225, 10, 100, 1, LightingProfile.numLEDStrip, Direction.Forward);
  }

  public void setDisabledLightShow() {
    animation = new RainbowAnimation(0.8, 0.7, LightingProfile.numLEDStrip);
