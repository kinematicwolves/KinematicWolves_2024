...
public class Vision extends SubsystemBase {
  ...
  // Limelight object
  // private NetworkTable targetData = NetworkTableInstance.getDefault().getTable("limelight").getEntry("jman").getDoubleArray(new double[6]);
  // private NetworkTable apriltagData = NetworkTableInstance.getDefault().getTable("limelight").getEntry("jman").getDouble(0);
  // private NetworkTable cameraControls = NetworkTableInstance.getDefault().getTable("limelight").getEntry("jman").setNumber(1);
  ...
  //   return(v_angle + LimelightProfile.limelightVerticalAngle);
  // }
  ...
  //   pipelineControls.setNumber(LimelightProfile.limelightVerticalAngle);
  // }

  // public void setDriverCameraMode() {
  //   cameraModeControl.setNumber(LimelightProfile.driverCameraEntry);
  // }

  // public void setVisionProcessMode() {
  //   cameraModeControl.setNumber(Constants.LimelightProfile.visionProcessorEntry);
  // }
