...
public class CenterRightAuto extends SequentialCommandGroup {
    public CenterRightAuto (Swerve s_Swerve, Arm s_Arm, Intake s_Intake, Lighting s_Lighting){
        ...
        Trajectory rightNote =
            TrajectoryGenerator.generateTrajectory(
              ...
              new Pose2d(1.72, -2.6, new Rotation2d(0.31)),  
        ...
        Trajectory middleNote =
            TrajectoryGenerator.generateTrajectory(
              ...
              new Pose2d(-0.16, 2.4, new Rotation2d(-0.14)),
                config);
        ...
        Trajectory leftNote =
            TrajectoryGenerator.generateTrajectory(
                ...
                new Pose2d(0, 0, new Rotation2d(0)),
              List.of(new Translation2d(-0.4, 0.5)),
              new Pose2d(-0.08, 2.25, new Rotation2d(-0.38)),
                config);
