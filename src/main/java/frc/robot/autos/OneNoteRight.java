...
public class OneNoteRight extends SequentialCommandGroup {
    public OneNoteRight(Swerve s_Swerve, Arm s_Arm, Intake s_Intake, Lighting s_Lighting){
        ...
        addCommands(
            ...
            //new TimedShootNote(s_Intake, s_Arm, s_Lighting, ArmProfile.kpivotSpeakerPos, 30, 15, 2),
