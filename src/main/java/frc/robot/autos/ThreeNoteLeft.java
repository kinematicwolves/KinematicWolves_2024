...
public class ThreeNoteLeft extends SequentialCommandGroup {
    public ThreeNoteLeft(Swerve s_Swerve, Arm s_Arm, Intake s_Intake, Lighting s_Lighting){
        ...
        Trajectory leftNote =
            TrajectoryGenerator.generateTrajectory(
              ...
              new Pose2d(0, 2, new Rotation2d(-0.1)),
                config);
        ...
        addCommands(
            ...
            new TimedShootNote(s_Intake, s_Arm, s_Lighting, 24800, 0.32, 0.15, 2),
