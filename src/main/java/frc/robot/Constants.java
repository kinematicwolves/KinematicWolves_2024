...
public final class Constants {
  ...
  public static class ArmProfile {
    ...
    public static final double kPivotPosThreshold = 600;
    public static final double pivotInitialPos = 0;
    public static final double kpivotSpeakerPos = 9500;
    public static final double kpivotAmpPos = 44834;
    public static final double kPivotClimbPos = 45000;
    ...
    public static final double kShooterAmpOutput = 0.5;
  ...
  public static class ClimberProfile {
    ...
    /* Threshold and Setpoints */ //TODO: These must be configured
  ...
  public static class LightingProfile {
    ...
    public static final int numLEDStrip = 30; //TODO: Must be configured
  }
  ...
  public static final class SwerveProfile {
        ...
        public static final double openLoopRamp = 0.22;
        ...
        /** Radians per Second */
        public static final double maxAngularVelocity = 3; // 13.99r/s before weight
        /** Fractional Percentage **/
        public static final double speedCap = 0.3; // Must be configured
        ...
        public static final class Mod0 {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(133.7);
        ...
        public static final class Mod1 {
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(61.7);
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
